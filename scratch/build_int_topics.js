...
fs.writeFileSync(path.join(__dirname, 'expanded_int_topics.json'), JSON.stringify(intTopics, null, 2));
console.log("Adding 15 detailed intermediate topics successfully prepared!");
