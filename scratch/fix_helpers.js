...
if (!code.includes('export function getTopicsByLevel')) {
  fs.appendFileSync(targetPath, helpersCode, 'utf8');
  console.log('Successfully restored helper functions to grammar-data.js!');
} else {
